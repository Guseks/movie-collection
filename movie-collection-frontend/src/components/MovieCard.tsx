...
const MovieCard = ({ movie, genres }: movieCardProps) => {
  ...
  return (
    <Card className="h-sm lg:h-lg w-72 lg:w-64 border-2 border-stone-900 lg:border-stone-950  relative rounded-sm pb-3 hover:border-stone-300 hover:cursor-pointer">
      <img
        className=""
        key={movie.id}
